@empty($rekomendasi)
    ...
    @else
        <form action="{{ url('/rekomendasi/' . $program->id_program . '/update_ajax') }}" method="POST" id="form-edit">
            @csrf
            @method('PUT')
            <div id="modal-master" class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                ...
                                <input value="" type="text" name="nana_program" id="nana_program" class="form-control" required>
                                <small id="error-nana_program" class="error-text form-text text-danger"></small>
                            </div>             
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input value="" type="date" name="kuota_program" id="kuota_program" class="form-control" required>
                                <small id="error-kuota_program" class="error-text form-text text-danger"></small>
                            </div>

                            {{-- <div class="form-group row">
                                <label class="col-2 control-label col-form-label">Bukti rekomendasi</label>
                                <div class="col-10">
                                    @if($rekomendasi->bukti_sertif)
                                        <a href="{{ asset('image/bukti/' . $rekomendasi->bukti_sertif) }}" target="_blank">Lihat Bukti rekomendasi</a>
                                    @else
