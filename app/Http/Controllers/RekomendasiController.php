...
class rekomendasiController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('rekomendasi.index', ['breadcrumb' => $breadcrumb, 'page' => $page, 'activeMenu' => $activeMenu]);
    }
    ...
    public function list(Request $request)
    {
        ...
        return DataTables::of($rekomendasi)
            ...
            ->addColumn('aksi', function ($rekomendasi) {
                ...
                // $btn = '<a href="' . url('/rekomendasi/' . $rekomendasi->id_rekomendasi) . '" class="btn btn-info btn-sm">Detail</a> ';
                // $btn .= '<a href="' . url('/rekomendasi/' . $rekomendasi->id_rekomendasi . '/edit') . '" class="btn btn-warning btn-sm">Edit</a> ';
                // $btn .= '<form class="d-inline-block" method="POST" action="' . url('/rekomendasi/' . $rekomendasi->id_rekomendasi) . '">'
                //     . csrf_field() . method_field('DELETE') .
                //     '<button type="submit" class="btn btn-danger btn-sm" onclick="return confirm(\'Apakah Anda yakin menghapus data ini?\');">Hapus</button></form>';
                // return $btn;

                $btn = '<a href="' . url('/rekomendasi/' . $rekomendasi->id_rekomendasi) . '" class="btn btn-info btn-sm">Detail</a> ';
                $btn .= '<button onclick="modalAction(\'' . url('/rekomendasi/' . $rekomendasi->id_rekomendasi . '/edit_ajax') . '\')" class="btn btn-warning btn-sm">Edit</button> ';
                $btn .= '<button onclick="modalAction(\'' . url('/rekomendasi/' . $rekomendasi->id_rekomendasi . '/delete_ajax') . '\')" class="btn btn-danger btn-sm">Hapus</button> ';
    ...
    public function show_ajax(string $id)
    {
        ...
        return view('rekomendasi.show_ajax', ['rekomendasi' => $rekomendasi, 'jenis_program']); // => $jenis_program, 'nama_program' => $nama_program, 'matkul' => $matkul, 'bidang_minat' => $bidang_minat, 'level_program' => $level_program, 'kuota_program' => $kuota_program]);
    }
    ...
    public function store_ajax(Request $request)
    {
        ...
        if ($request->ajax() || $request->wantsJson()) {
            $rules = [
                ...
                'kuota_program'            => 'required|integer'
            ];
            // use Illuminate\Support\Facades\Validator;
    ...
    public function edit_ajax(string $id)
    {
        ...
        // $matkul = MatKulModel::all();
        // $bidang_minat = BidangMinatModel::all();
        return view('rekomendasi.edit_ajax', ['rekomendasi' => $rekomendasi]);
    }
